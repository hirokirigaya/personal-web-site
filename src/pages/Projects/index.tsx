...
const Projects = (): JSX.Element => {
  ...
  let repositoriesList  = repositories.slice((currentPage - 1) * maxItensPerPage, currentPage * maxItensPerPage);
    ...
    <Styled.Container>
      <Styled.FirstSection>
        <div className='title-first-section' ref={titleFistSection}>
          <Styled.TitleFirstSection color={cores[current]}>Projetos</Styled.TitleFirstSection>
        </div>
        <div ref={slider}>
              ...
              >
                <div className='content-box'>
                  ...
                  <div className='data-repository'>
                    ...
                    <a href={repository.html_url} target="_blank"><FiArrowRight /></a>
                  </div>
                </div>
              </Card>
            ))}
