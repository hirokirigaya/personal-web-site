    ...
    <Styled.Container>
      <div className="content-footer" id="contato">
        <div className="contact">
          ...
          <a
            href="mailto:danielferreiradeveloper@gmail.com"
            title="Enviar e-mail para danielferreiradeveloper@gmail.com"
          >
            danielferreiradeveloper@gmail.com
          </a>
        </div>
        <Styled.Navigation>
          <ul>
      ...
      <p className="copyright">
        All Copyrights © {new Date().getFullYear()} Daniel Ferreira
      </p>
    </Styled.Container>
  );
};
